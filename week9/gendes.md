...
Generative design is a new model for architecture and design, having only emerged in the 1980s. There are, however, a few notable experiments that point to a future of *grown*, adaptive objects and structures.
